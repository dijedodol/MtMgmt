...
<html>
	<head>
		...
		<title>Admin - Update Part Failure Mode Handling</title>
	</head>
	<body>
		<a href="index.htm">List Part Failure Mode Handlings</a> | <a href="add.htm">Add Part Failure Mode Handling</a>
		<sf:errors path="*"/>
			...
			<fieldset>
				...
				<section>
					<sf:label path="code">Code</sf:label>
						<div>
						<sf:input path="code" id="code" readonly="true"/>
					</div>
				</section>
				<section>
					<sf:label path="handlingCode">Handling Code</sf:label>
						<div>
						<sf:input path="handlingCode" readonly="true"/>
					</div>
				</section>
				<section>
